...
export default function Contact() {
  ...
  return (
    <footer className="bg-brand-obsidian py-32 px-6 md:px-20 border-t border-white/5" style={{ color: neutralSand }}>
      <div className="max-w-[1800px] mx-auto">
          ...
          <div>
            ...
            <div className="space-y-6">
              <a 
                ...
                className="text-2xl md:text-4xl font-medium border-b-2 border-brand-yellow pb-2 hover:text-brand-yellow transition-colors duration-300 block w-fit"
              >
                bogalesaron@gmail.com
              </a>
              <a 
                href="tel:+251931313204" 
                className="text-xl md:text-2xl font-medium opacity-80 hover:text-brand-yellow transition-colors duration-300 block w-fit"
              >
                +251 931 313 204
              </a>
            </div>
        ...
        <div className="mt-32 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center opacity-30 text-[10px] uppercase tracking-[0.3em] font-black">
